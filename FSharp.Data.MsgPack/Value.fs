...
module MsgPackValue =
  ...
  module Limited =
    ...
    let MUInt8 value : MsgPackValue = MUInt8 value
    let MUInt16 value : MsgPackValue = MUInt16 value
    let MUInt32 value : MsgPackValue = MUInt32 value
    let MUInt64 value : MsgPackValue = MUInt64 value
    let MInt8 value : MsgPackValue = MInt8 value
    let MInt16 value : MsgPackValue = MInt16 value
    let MInt32 value : MsgPackValue = MInt32 value
    let MInt64 value : MsgPackValue = MInt64 value
    let MFloat32 value : MsgPackValue = MFloat32 value
    let MFloat64 value : MsgPackValue = MFloat64 value
    let MString value : MsgPackValue = MString value
    let Binary value : MsgPackValue = Binary value
    let MArray values : MsgPackValue = MArray values
    let MMap map : MsgPackValue = MMap map
